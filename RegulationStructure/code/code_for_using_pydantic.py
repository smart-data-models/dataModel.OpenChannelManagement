...
class Type6(Enum):
    RegulationStructure = 'RegulationStructure'
...
class RegulationStructure(BaseModel):
    ...
    ] = Field(None, description='Reference to an entity of type Sluice gate')
    hasSpillway: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
                min_length=1,
    ...
    ] = Field(None, description='Reference to an entity of type Sluice gate Spillway')
    id: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
