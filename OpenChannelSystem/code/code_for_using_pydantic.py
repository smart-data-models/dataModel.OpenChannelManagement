...
class Type6(Enum):
    OpenChannelSystem = 'OpenChannelSystem'


class OpenChannelSystem(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It has to be OpenChannelSystem'
    )
