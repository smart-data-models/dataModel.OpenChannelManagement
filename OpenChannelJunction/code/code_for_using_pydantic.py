...
class Type6(Enum):
    OpenChannelJunction = 'OpenChannelJunction'


class OpenChannelJunction(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type. it has to be OpenChannelJunction'
    )
    uniqueName: Optional[str] = Field(None, description='The name of the junction')
    ...
    waterInflow: Optional[confloat(ge=0.0)] = Field(
        None, description='Water flow inserted to the junction'
    )
    waterLevel: Optional[confloat(ge=0.0)] = Field(
        None, description='Water level at the junction'
    )
    waterOutflow: Optional[confloat(ge=0.0)] = Field(
        None,
